...
def main(args=None):
    ...
    parser_conv.add_argument("-e","--include_events", action="store_true", default=False, help="NON-IMPLEMENTED Include the event table data for basecalled fastq (default: %(default)s)")
    parser_conv.add_argument("-a","--include_fastq", action="store_true", default=False, help="NON-IMPLEMENTED Include the fastq data for basecalled fastq (default: %(default)s)")
    ...
    parser_rconv.add_argument("-t","--output_type", default="fast5", choices=["fastq","fast5","basecalled_fast5"], help="NON-IMPLEMENTED Dump either fastq, fast5 or basecalled_fast5 (default: %(default)s)")
    parser_rconv.add_argument("--n_reads_fast5", type=int, default=4000, help="NON-IMPLEMENTED Number of reads per fast5 files (default: %(default)s)")
    parser_rconv.add_argument("--n_reads_fastq", type=int, default=0, help="NON-IMPLEMENTED Number of reads per fast5 files (default: %(default)s)")
