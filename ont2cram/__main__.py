...
#fix for imports in script mode
import sys
sys.path.append('./')
...
def main(args=None):
    ...
    parser_conv.set_defaults(func=converter.converter)
    ...
    parser_rconv.set_defaults(func=reverse_converter.reverse_converter)
